...
public class UserRegistrationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("mobileNo"))) {
			...
			request.setAttribute("mobileNo", "Mobile No. must contain 10 Digits & Series start with 6-9");
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("password"))) {
			...
			request.setAttribute("password", "Password must contain alphabets , special characters and integers! ");
			pass = false;
		}
		...
		if (DataValidator.isNull(dob)) {
			...
			request.setAttribute("dob", PropertyReader.getValue("error.require", "Minimum Age 18 years"));
			pass = false;
		}
