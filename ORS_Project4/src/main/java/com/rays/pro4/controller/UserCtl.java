...
public class UserCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("firstName"))) {
			...
			request.setAttribute("firstName", "First Name should contain alphabets only");
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			...
			request.setAttribute("lastName", " Last Name should contain alphabets only");
			pass = false;
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (id > 0 || op != null) {
			...
			try {
				...
				System.out.println("Jayati11111111111");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SAVE.equalsIgnoreCase(op) || OP_UPDATE.equalsIgnoreCase(op)) {
			...
			try {
				...
				System.out.println(" Uctl Do post 4444444");
				ServletUtility.setBean(bean, request);
				ServletUtility.setErrorMessage("Login id already exists", request);
			}
		} else if (OP_DELETE.equalsIgnoreCase(op)) {
			System.out.println(" Uctl Do post 5555555");

			UserBean bean = (UserBean) populateBean(request);
			try {
				model.delete(bean);
				System.out.println(" uctl Do Post  6666666");
			...
			System.out.println(" Uctl Do post 77777");
