...
public class MarksheetModel {
	...
	/**
	 *  Searches a Marksheet with pagination 
	 * 
	 */
	...
	public List search(MarksheetBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		// sql injection => or 1=1 (value must be true)
		if (bean != null) {
	...
	/**
	 *    Get Meritlist of Marksheet with Pagination
	 * 
	 */
